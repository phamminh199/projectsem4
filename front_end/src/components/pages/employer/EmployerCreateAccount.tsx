...
import { validatePassword,getUserSignIn, validateEmail,validatePhone,validateBirthday,validateFullName, wait, hashPassword, comparePassword } from '../../share/sharedFunction';
...
// sdfjhLKhl349(*&)
   ...
   const handleSubmitAdd = async (e: React.FormEvent<HTMLFormElement>) => {
      ...
      let idcompanyOfUserSignIn = obj.idcompany; // lấy idcompany của người đang sign in, tức mình tạo account mới có cùng idcompany, cùng công ty với nhau
      
      const data = 
      {
         idcompany: idcompanyOfUserSignIn,
   ...
   return (
      <div className={clsx(styles.component_EmployerCreateAccount)}>

         <form onSubmit = {handleSubmitAdd} className={clsx(styles.formSignUp)}>
            <h2>CREATE NEW EMPLOYER ACCOUNT</h2>
{/* --------------------------------------------------------------- */}
